...
#define FLIGHT_ALTITUDE 0.2f
#define X_OFFSET 0.15f
...
int main(int argc, char **argv)
{
    ...
    pose.pose.orientation.z = -0.707; // fix initial orientation
    pose.pose.orientation.w = -0.707; // fix initial orientation
